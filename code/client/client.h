...
typedef struct {
	...
	/* cgameUserCmdValue weapon values
	 * UT_WP_KNIFE		= 1
	 * UT_WP_BERETTA	= 2
	 * UT_WP_DEAGLE		= 3
	 * UT_WP_SPAS12		= 4
	 ...
	 * UT_WP_PSG1		= 10
	 * UT_WP_GRENADE_HE	= 11
	 * UT_WP_GRENADE_FLASH	= 12
	 * UT_WP_GRENADE_SMOKE	= 13
	 * UT_WP_SR8		= 14
	 * UT_WP_AK103		= 15
	 * UT_WP_BOMB		= 16
	 * UT_WP_NEGEV		= 17
	 * UT_WP_GRENADE_FRAG	= 18
	 * UT_WP_M4		= 19
	 * UT_WP_GLOCK		= 20
	 * UT_WP_COLT1911	= 21
	 * UT_WP_MAC11		= 22
	...
	*/
	...
	int lastHealth;
	short int done_reconnect;
	qboolean sniperDrawn; // might be useful later
} clientActive_t;
...
extern	cvar_t	*cl_persistentcrosshair;
...
extern	cvar_t	*cl_autodropkevonflag;
extern  cvar_t  *cl_autoclick;
