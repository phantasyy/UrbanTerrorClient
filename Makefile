...
ifneq ($(BUILD_CLIENT),0)
  TARGETS += $(B)/Quake3-UrTMod.$(ARCH)$(BINEXT)
...
# Asset replacement
ifeq ($(USE_REPLACE_ASSETS),1)
  BASE_CFLAGS += -DUSE_REPLACE_ASSETS=1
endif
...
targets: makedirs tools
	@echo ""
ifneq ($(SHOWINFO),0)
	@echo "Building Quake3-UrTMod in $(B):"
...
$(B)/Quake3-UrTMod.$(ARCH)$(BINEXT): $(Q3OBJ) $(Q3POBJ) $(LIBSDLMAIN)
...
ifneq ($(BUILD_CLIENT),0)
	$(INSTALL) -s -m 0755 $(BR)/Quake3-UrTMod.$(ARCH)$(BINEXT) $(COPYDIR)/Quake3-UrTMod.$(ARCH)$(BINEXT)
endif
